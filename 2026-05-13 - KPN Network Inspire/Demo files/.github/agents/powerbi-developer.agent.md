...
3. **Check for a task plan** — Look for a Tasks section in the spec.
   ...
   - If no tasks exist, create a plan in a separate document (`specs and principles/[SpecName].plan.md`) and execute from there.
...
5. **Execution summary** — After implementation, produce a summary of work done in `specs and principles/[SpecName].ExecutionSummary.md`.
