...
- Look for a `team-standards.md` file in the `specs and principles/` folder. If it exists, respect it in the spec.
...
## Guidelines
- Specs are saved under a `specs and principles/` folder in the working directory.
